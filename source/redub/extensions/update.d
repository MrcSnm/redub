...
int updateMain(string[] args)
{
    ...
    if(replaceRedub)
    {
        ...
        ProjectDetails d = redub.api.resolveDependencies(ResolveInfo.init, CompilationDetails(compilerOrPath: update.compiler, combinedBuild:!update.fast), ProjectToParse(update.dev ? "cli-dev" : null, redubPath), InitialDubVariables.init, bt);
